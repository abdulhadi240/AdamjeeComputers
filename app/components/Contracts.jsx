  ...
  return (
    <div>
        ...
        <div className='sm:px-16 px-4 lg:px-24 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6'>
          <ContactCard label={'sales@adamjee.com'} Ricons={BsChat} Heading={'Chat to sales'} text={'Speak to our friendly team.'} link={'https://mail.google.com/mail/?view=cm&to=sale@admajeecomputers.com&su=Your%20Subject&body=Your%20Message'} />
          ...
          <ContactCard label={'0300 7079539'} Ricons={BiPhoneCall} Heading={'Call us'} text={'We are 24/7 available'} link={'./'} />
